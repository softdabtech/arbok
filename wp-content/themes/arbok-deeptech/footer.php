...
<footer class="site-footer">
    <div class="shell footer-grid">
        ...
        <div><h2>Explore</h2><ul class="footer-links"><li><a href="<?php echo esc_url(get_post_type_archive_link('technology')); ?>">Technologies</a></li><li><a href="<?php echo esc_url(home_url('/water-solutions/')); ?>">Water solutions</a></li><li><a href="<?php echo esc_url(home_url('/directions/')); ?>">Strategic directions</a></li><li><a href="<?php echo esc_url(home_url('/critical-metals-book/')); ?>">Critical Metals book</a></li><li><a href="<?php echo esc_url(get_post_type_archive_link('sector')); ?>">Detailed sectors</a></li><li><a href="<?php echo esc_url(get_post_type_archive_link('team_member')); ?>">Team</a></li><li><a href="<?php echo esc_url(get_post_type_archive_link('update')); ?>">Blog</a></li></ul></div>
